  ...
  return (
    <>
      <div
        className={
          from?.length
            ? "bg-green-100 text-gray-600 my-2 p-2 table text-sm rounded-md w-[300px] "
      ...
      >
        <p className="py-1">
          Moneda: {base}{" "}
          {base !== "USD" ? (
            <img className="h-4 w-4 inline-block" src={colFlag} alt="Flag" />
          ) : (
            <img className="h-4 w-4 inline-block" src={usaFlag} alt="Flag" />
          )}
        </p>
        <p className="py-1">
          Moneda de cambio: {target}{" "}
          {target !== "USD" ? (
            <img className="h-4 w-4 inline-block" src={colFlag} alt="Flag" />
          ) : (
            <img className="h-4 w-4 inline-block" src={usaFlag} alt="Flag" />
        ...
        <p className="py-1">
          Monto a cambiar: <strong>$ {amount}</strong>
        </p>
        <p className="py-1">
          Monto convertido: <strong>$ {result}</strong>
        </p>
